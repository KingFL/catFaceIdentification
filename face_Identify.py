...
# 测试识别率
list_path='./DataSet/face_test/list_val.txt'
fd = open(list_path)
...
# model_dir = r'./DataSet/6000-10000/catfaces_train.models-10000'  # 模型地址
# model_dir = r'./DataSet/models/11000-15000/catfaecs_train.models-15000'  # 模型地址
# model_dir = r'./DataSet/models/16000-20000/catfaecs_train.models-20000'  # 模型地址
...
with tf.Session() as sess:
    ...
    for li in lines:
        ...
        rate = num_true/(num_flase+num_true)
        print(str(num_true) + " / " + str(num_flase+num_true) + " (" + str(rate) + ")")
